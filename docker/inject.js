...
const REPLACEMENTS = {
  ...
  __VITE_CAMERA_SEGMENTER_WASM_URL__:
    process.env.VITE_CAMERA_SEGMENTER_WASM_URL || "",
  __VITE_CAMERA_SEGMENTER_MODEL_URL__:
    process.env.VITE_CAMERA_SEGMENTER_MODEL_URL || "",
};
