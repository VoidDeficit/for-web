...
ENV VITE_CAMERA_SEGMENTER_WASM_URL=__VITE_CAMERA_SEGMENTER_WASM_URL__
ENV VITE_CAMERA_SEGMENTER_MODEL_URL=__VITE_CAMERA_SEGMENTER_MODEL_URL__
...
ENV VITE_CAMERA_SEGMENTER_WASM_URL=""
ENV VITE_CAMERA_SEGMENTER_MODEL_URL=""
